...
| iMessages read | 4,509 (15 conversations) |
| Photos analyzed | 18,308 |
| Flights analyzed | 4,292 |
| People identified (facial recognition) | 473 |
| Flagged items with notes | 1,122,867 |
...
| Financial flows documented | $3.2 billion+ |
...
|--------|-------|----------|
| DOJ EFTA Releases (justice.gov/epstein) | 1,413,417 documents | Volumes 8-12, DataSet11, supplements |
| jmail.world Email Archive | 1,783,792 emails | All accounts, 2005-2025 |
| iMessage Extractions | 4,509 messages | 15 conversations incl. Bannon, Summers, Plaskett |
| Photographic Evidence | 18,308 images | Crime scene, properties, identified individuals |
| Flight Records | 4,292 flights | Full passenger manifests |
| Unredacted Files | 25,000+ pages | Datasets 1-8, flight logs, prosecution memos |

## FOIA Requests

20 FOIA requests targeting records no known party has sought. Printable letters in [FOIA_Letters/](FOIA_Letters/). Anyone can file them.
...
- [Signing Key](signing_key.asc) | [Chain of Custody](CHAIN_OF_CUSTODY.md)
...
*For the kids that could still fall to this machine.*
