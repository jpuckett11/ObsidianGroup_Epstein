...
## The Starting Point: ~$600 Million (at death, August 2019)

## What's Been Paid Out

| Payment | Amount | To Whom | When |
|---------|--------|---------|------|
| IRS estimated tax | $190M | IRS (overpaid) | July 2020 |
| IRS refund returned | -$112M | Back to estate/1953 Trust | ~2024 |
| Victim Compensation Program | $121M+ | 150+ victims | 2020-2023 |
| USVI AG settlement | $105M | Government of USVI | 2022 |
| Victim class action (Indyke/Kahn) | $35M | Victim class | Feb 2026 |
| Property sales: NYC mansion | $51M | Estate (sold March 2021) |
| Property sales: Islands | ~$60M | Estate ($30M net after USVI half) |
| Property sales: Palm Beach | $25M+ | Estate |
| Legal fees / estate admin | Tens of millions | Various law firms + executors |
| **NET: ~$600M → ~$127-145M remaining** | | |
...
**What Indyke and Kahn have been paid:**
...
**Grants paid:** $768 in 2015 (entire year). One known payment: $160,000 for Epstein's environmental fines
**Harvard connection:** Gave thousands to Hasty Pudding and a professor's TV show (per Harvard Crimson)
...
- $10M annuity for unnamed beneficiary
- $10M annuity for another unnamed beneficiary
- $4M annuities for multiple beneficiaries
- $2M annuities for multiple beneficiaries (including Yulia Silinskaya)

**If these annuities were purchased before death**, they're held by insurance companies and pay directly to beneficiaries regardless of estate proceedings. They would NOT be captured by the USVI AG settlement unless specifically identified and clawed back.
...
- Trust allocated $10M operating expenses fund for Paris + island properties
- Whether the Paris property was sold or remains in trust is unclear from public records
...
### Confirmed Active Payments:
| Recipient | Source | Amount | Status |
|-----------|--------|--------|--------|
| Indyke | Estate (executor compensation) | Unknown/year | Ongoing |
| Kahn | Estate (executor compensation) | Unknown/year | Ongoing |
| Law firms | Estate (legal defense) | Millions/year | Ongoing |
| Property management | Estate | Unknown | Ongoing (remaining properties) |
| Annuity beneficiaries | Insurance companies | Up to $56M total | Unknown if purchased |
| Karyna Shuliak | Trust (if annuity purchased) | Up to $20M annuity | Unknown |

### Recently Paid:
| Payment | Amount | Date |
|---------|--------|------|
| Victim class action | $35M | Feb 2026 |
| USVI AG settlement | $105M | 2022 |
| Victim Compensation Program | $121M+ | 2020-2023 |
...
## The Hypothetical Access Map

If someone needed to access Epstein-connected money without going through the frozen/settled estate:

```
ACCESSIBLE NOW (no court order blocking):
├── Gratitude America: $8.17M (USVI, Indyke/Kahn control)
├── Southern Country Intl mystery: $12.9M (passed through, destination unknown)
├── Gulfstream G550 sale proceeds: Up to $16.9M (Plan D LLC, listed for sale)
├── Crypto wallets: $? (if keys exist)
├── Insurance annuities: Up to $56M+ (if purchased before death)
├── Paris property/accounts: $? (French jurisdiction)
├── Butterfly Trust residual: $? (beneficiaries still receiving?)
└── 35+ unidentified shell companies: $? (of 56 known per KPMG, only 10 in USVI settlement)

CONTROLLED BY INDYKE/KAHN:
├── 1953 Trust: $127-145M (pending "resolution of all claims")
├── Gratitude America: $8.17M
├── Remaining property proceeds
└── Estate operating accounts

FROZEN/SETTLED:
├── USVI AG: $105M + half of island sale
├── Victim Compensation: $121M+ paid out
├── Class action: $35M
└── IRS: $78M net
```
...
- IRS 990PF filings: ProPublica Nonprofit Explorer (EIN 66-0789697)
- USVI AG settlement: usvidoj.com
- Estate Wikipedia: en.wikipedia.org/wiki/Estate_of_Jeffrey_Epstein
- Trust document: EFTA01266134/EFTA01266204 (from our extraction)
- Harvard Crimson: Gratitude America donations to Hasty Pudding
- smw.ai: 46 entity corporate structure
- ICIJ Paradise Papers: Liquid Funding Ltd offshore trace
- NBC News: $35M class action settlement
- GV Wire: $112M tax refund
...
- Trust document: EFTA01266134/EFTA01266204 (from our extraction)
- Harvard Crimson: Gratitude America donations to Hasty Pudding
- KPMG Forensic Review: 56 entities identified
- ICIJ Paradise Papers: Liquid Funding Ltd offshore trace
- NBC News: $35M class action settlement + Indyke/Kahn never interviewed
- GV Wire: $112M tax refund
- Seattle Times: Southern Country International mystery bank (July 2020)
- Daily Beast: Southern Country $15.5M estate transfer
- Senate Finance Committee: Wyden investigation expansion (Sep/Dec 2025)
- House Oversight: Subpoenas for Wexner, Indyke, Kahn (Jan 2026)
- La Voce di New York: $35M settlement + secret trust resurfaces (Feb 2026)
...
| Date | Event | Amount |
|------|-------|--------|
| 2011 | Epstein first attempts to buy Bin Ennakhil palace, Marrakech | Unknown |
| 2011-2019 | Negotiations continue for years | |
| **April 2019** | **Schwab opens THREE accounts for Epstein companies** (including Southern Trust) | |
...
- 4.6 hectares (11.4 acres)
- 60 marble fountains, mosaic-tiled courtyards
- Gold-draped salons, gardens with olive trees and 2,000+ palms
- Hammam steam spa beneath carved ceilings
- Asking price: ~€25 million ($29.5M)
- Previously owned through Pamur Anstalt (Liechtenstein shell, dissolved June 2023)
...
### Why Was Epstein Buying a Palace 10 Days Before His Arrest?
