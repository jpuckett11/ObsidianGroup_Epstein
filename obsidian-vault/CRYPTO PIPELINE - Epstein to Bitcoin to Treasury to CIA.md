# CRYPTO PIPELINE, Epstein → Bitcoin → Treasury → CIA Director Burns

## Timeline

| Date | Event | Source |
|------|-------|--------|
| 1996 | NSA publishes "How to Make a Mint: Cryptography of Anonymous Electronic Cash" | NSA.gov |
| Oct 2008 | Bitcoin whitepaper published by "Satoshi Nakamoto", identity unknown | bitcoin.org |
| 2008-2009 | Epstein plea deal / county jail / work release | EFTA corpus |
| Jun 4, 2011 | Epstein: "jason,,? bitcoin guys?", urgently hunting Bitcoin developers | EFTA00714603 |
| Jun 5, 2011 | Jason Calacanis connects Epstein to Gavin Andresen + Amir Taaki | Email corpus |
| Jun 7, 2011 | Brockman: "Struck out with 8 people... could try to go directly to Gavin Andresen" | Email corpus |
| Jun 11, 2011 | Brockman emails Andresen about writing a Bitcoin book | Email corpus |
| Jun 11, 2011 | Epstein: "any luck on bitcoin?", still pushing | Email corpus |
| Jun 2011 | Epstein to Andresen: "The idea is great, the execution has some serious risks" | DOJ EFTA release |
| Jun 2011 | Andresen: "No, sorry, I'm busy", REJECTED Epstein | DOJ EFTA release |
| Jul 2011 | Epstein to Amir Taaki: "brilliant, but I suggest it has some serious downsides" | DOJ EFTA release |
| 2011 | Brock Pierce relationship with Epstein established | Email corpus |
| 2012 | Pierce scouting Moscow/Kiev/Odessa, "take photos," "find him a present" | DOJ EFTA release |
| 2012 | Pierce to Epstein: "had a great time with the girls" | DOJ EFTA release |
| 2002-2017 | Epstein donates $850K to MIT, $525K to MIT Media Lab Digital Currency Initiative | MIT records |
|, | Bitcoin Core devs Andresen, van der Laan, Cory Fields join MIT DCI, salaries funded by Epstein donations | Reporting |
| Aug 2014 | EPSTEIN MEETS U.S. TREASURY, Office of Terrorist Financing and Financial Crimes | DropSite News |
| Aug 2014 | Discussed: crypto for arms shipments, nuclear proliferation payments, sanctions evasion | DropSite News |
| Aug 2014 | After Treasury: private meeting with Dep SecState WILLIAM BURNS (Iran deal negotiator) | DropSite News |
| 2015 | Epstein invests $3M in Coinbase Series C through Brock Pierce | Fortune, CoinDesk |
| 2015 | Pierce co-founds Tether (now $8.23B reserves, $1.04B quarterly profit) | Public filings |
| Jul 2015 | Joi Ito emails Epstein about "Sand Hill Exchange and Xcoin", new crypto ventures | Email corpus |
| 2021 | William Burns appointed CIA Director by Biden | Public record |

## The Network in Crypto

| Person | Epstein Emails | Crypto Role | Connection |
|--------|---------------|-------------|------------|
| Brock Pierce | 938 | Bitcoin Foundation chairman, Tether co-founder, Coinbase investor | Scouted women in Russia/Ukraine for Epstein |
| Gavin Andresen | 10+ | Bitcoin Core lead developer, Satoshi's successor | Rejected Epstein's outreach; MIT DCI funded by Epstein |
| Joi Ito | 3,753 | MIT Media Lab director | Channeled Epstein donations to DCI, resigned over ties |
| Larry Summers | 1,722 | Former Treasury Secretary | Bitcoin meeting with Pierce at Epstein's townhouse |
| William Burns |, | Now CIA Director | Private meeting with Epstein after Treasury crypto session |
| Amir Taaki |, | Bitcoin Core developer | Contacted directly by Epstein about "downsides" |

## What Epstein Controlled

1. **Funded the developers**, $525K to MIT DCI employed Bitcoin's core team
2. **Tried to recruit the project leader**, Andresen said no
3. **Embedded his associate in the foundation**, Pierce became Bitcoin Foundation chairman
4. **Co-founded the stablecoin market**, Pierce co-founded Tether ($8.23B backing the entire crypto market)
5. **Invested in the on-ramp**, $3M in Coinbase (now ~$60B market cap)
6. **Advised the government on crypto**, Treasury meeting on sanctions evasion
7. **Then briefed the intelligence community**, private meeting with Burns (now CIA Director)

## The Question

Did Epstein or his intelligence network create Bitcoin?

**No evidence in the corpus.** The whitepaper was published during his incarceration. No emails about Bitcoin exist before June 2011. Satoshi/Nakamoto references in the corpus are forwarded articles, not personal correspondence.

**But he captured the infrastructure after it existed:**
- The developers (MIT funding)
- The foundation (Pierce as chairman)
- The stablecoin layer (Tether)
- The exchange layer (Coinbase)
- The government's understanding of it (Treasury meeting)
- The intelligence community's awareness of it (Burns meeting)

He didn't build the gun. He bought the ammunition factory, hired the people who load the magazines, and then walked into the Treasury Department and told them how the gun works, while his own people were using it.

## Verdict

**Tier 3, Hypothesis** on Bitcoin creation. No evidence.
**Tier 1, Documented** on infrastructure capture, MIT funding, Treasury advising, Burns meeting.
