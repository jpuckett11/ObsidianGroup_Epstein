...
**Claim:** We identified all anonymized persons in the consent order.
**Verification:** NYT (James Stewart) named Packard, Morris, Oldfield, Ford, Clarke, Chepiga in July 2020. Radical Compliance connected them to consent order designations. Our contribution is the DEEP PROFILES (career chains, current employers, Quigley/McFadden connection, Bridgewater sovereign wealth angle).
**STATUS: MUST CREDIT NYT/Radical Compliance for names. Our deep profiles and Quigley/McFadden thread IS original research.**

---

## SÃO PAULO → ZORRO RANCH HYPOTHESIS
...
- Credit BBC Brasil for discovering the São Paulo apartment
- Credit WIRED/Dhruv Mehrotra for phone-based island visitor tracking (different from our AIS ship tracking)
...
|----------|-------|-------------|
| Truly novel discoveries | ~15 | Methodology, GPS connections, vessel tracking, forensic observations |
| Novel connections/synthesis | ~20 | Chains nobody mapped, hypotheses nobody proposed |
| Deepened from others' work | ~15 | Profiles, context, verification of others' findings |
| Compiled/aggregated | ~13 | International developments, widely reported events |
| **TOTAL UNIQUE CONTRIBUTION** | **~50** | After removing inflated claims |

**The document should state: "This investigation includes approximately 15 original discoveries, 20 novel analytical connections, and comprehensive synthesis of findings from multiple independent research efforts, all sources credited."**

---

## SOURCES TO CREDIT IN PDF

| Source | What They Found | How We Used It |
|--------|----------------|----------------|
| R.S. Taylor (epstein-forensic-finance) | $2.146B audit, $412.3M gap, shell entity flows | Integrated into financial chapter, credited |
| NYT (James Stewart, July 2020) | NYDFS anonymized person names | Built deep profiles on top of, credited |
| Radical Compliance (Matt Kelly) | Connected names to consent order designations | Used as cross-reference, credited |
| BBC Brasil | São Paulo apartment discovery | Used as basis for Zorro Ranch hypothesis, credited |
| WIRED (Dhruv Mehrotra) | Phone location tracking of island visitors | Noted as different methodology from our AIS work, credited |
| DropSite News | Mongolia arms deal, Nigeria surveillance, Rothschild merger | Integrated into broker map, credited |
| Meduza | Russian connections, Novosibirsk, Myhrvold-Putin | Integrated into Russia chapter, credited |
| Al Jazeera | Israeli security installation, Nigeria spy tech, Barak connections | Integrated into Israel chapter, credited |
| Handala (hacker group) | Barak leaked emails (100K+) | Referenced for Mongolia/Thiel, credited |
| EpsteinExposed ("Eric Keller") | Database of 2.1M docs, person profiles, flight data | Cross-referenced our findings, credited |
| Senate Finance Committee (Wyden) | $1.1B single account, bank executive conduct, BNY Mellon probe | Financial chapter, credited |
| House Oversight Committee | Testimony transcripts, PI hard drives revelation, document releases | Congressional chapter, credited |
...
## CORRECTION ISSUED: DEREDACTION COUNT

**Previous claim:** "965 of 1,704 redactions broken (57%)"
**Corrected claim:** "ALL 1,704 redacted entries recovered (100%)"

**Verified data:**
- EFTA02730486: 1,704 REDACTED markers, 9,274 lines
- EFTA02730741: 0 REDACTED markers, 9,839 lines  
- Both confirmed as same FBI case file: SOD-NY-3027571
- 2,081 lines match exactly between documents
- 1,316 lines of unique recovered content in 741
- The "965" was from an incomplete preliminary analysis

**The corrected claim is STRONGER than the original.** We recovered 100% of the redacted content, not 57%. The deredaction is complete.

**IMPORTANT CAVEAT that must be in the PDF:**
This technique works because the DOJ released TWO VERSIONS of the same document with different redaction levels. This is a DOJ filing error, not a code-breaking achievement. Our contribution is IDENTIFYING that these two documents were the same case file and systematically extracting the differences. The technique is replicable by anyone with both documents.
