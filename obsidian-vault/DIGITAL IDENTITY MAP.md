...
## CONFIRMED EMAIL ACCOUNTS

| Email | Platform | Usage | Source |
|-------|----------|-------|--------|
| **jeevacation@gmail.com** | Gmail | Primary personal email. Used for YouTube, scheduling, personal comms | DOJ files, House Oversight |
| **jeeproject@yahoo.com** | Yahoo | 18,700 emails obtained (2002-2022). Still receiving emails years after death | DOJ files |
| Outlook account | Microsoft | Accessed by Redditors with leaked password. Mostly empty | Cybernews |

## CONFIRMED ONLINE ACCOUNTS
...
| **Pinterest** | Jeffrey Epstein | Unknown | Same username as Twitter |
| **Spotify** | Unknown | Unknown | Same username pattern |
| **Outlook** | Unknown | **#1Island** | Accessed by Redditors, flooded with trolling |
...
### Pattern: Password Reuse
- Same or similar passwords across multiple platforms
- No 2FA on most accounts (pre-2013 era)
- Weak passwords = either didn't care about security or assumed nobody would look
- "ghislaine" as Dropbox password = she had access to whatever was stored there

### The Dropbox Question
Password "ghislaine" worked. Someone accessed it. What was inside?
...
### Credit Card Exposed
- Full credit card number, expiration date, AND security code left unredacted in DOJ files
- This is a DOJ filing error, not our finding
- But it shows the level of carelessness in the release
...
*His master password was her name. The key to his digital life was Ghislaine Maxwell.*
