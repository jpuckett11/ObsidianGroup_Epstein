...
Elon Musk: $200B+. Owns a private island? No.
...
- Bell 430 helicopter ($5.5M)
- Fleet of vehicles across properties
- Full-time staff on four continents

Estate valued at $690M? With no verified income source?

## DOCUMENTED INFLOWS

### From Named Sources
| Source | Amount | Documentation |
|--------|--------|---------------|
| Leon Black / Apollo | $170M+ | Senate Finance Committee (Wyden) |
...
|------|-------------------|-------|
| BNY Mellon | $378M (270 wire transfers) | No legitimate business purpose for ANY |
| Deutsche Bank | Hundreds of millions (2013-2019) | $75M settlement |
| JPMorgan Chase | 15+ years of accounts | $365M settlement |
| Sberbank Russia | FEDWIRE from Deutsche Bank | DB-SDNY-0047940 |
| First Bank PR | Aviation + island entities | EFTA01269100 |
| Merrill Lynch | Trading positions | 2005-2006 emails |

## DOCUMENTED OUTFLOWS

| Recipient | Amount |
|-----------|--------|
| JPMorgan (USVI AG) | $75M |
| JPMorgan (class action) | $290M |
| Deutsche Bank | $75M |
| Leon Black / Apollo | $148M+ |
| Victims' Compensation | $121M+ |
| Individual settlements | $350M+ est |
| Legal fees (decades) | $100M+ est |
| **Total outflows** | **$1.16B+** |
...
- Outflows: $1.16B+
- Remaining: $307M
- Gap: $134M unaccounted
- Estate + outflows = $1.85B MINIMUM documentable
- Real throughput including banking: $2.5B+
...
| Estimate | Amount | Basis |
|----------|--------|-------|
| Estate disclosed | $690M-742M | Indyke/Kahn (both beneficiaries) |
| Conservative (documented) | $2-3B | Estate + settlements + banking |
| Realistic (including hidden) | $5-10B | Add Wexner POA, crypto, unsettled entities |
| Maximum (if Wexner flow audited) | $10B+ | Depends on POA scope |

## WHY NO ONE HAS LOOKED

- IRS never audited Epstein transactions (Wyden confirmed)
- No forensic accounting of Wexner POA period
- 35 of 56 entities unsettled
- 2005 computer never searched
- Crypto never traced
- Sberbank never subpoenaed
- Estate executors (Indyke/Kahn) are also trust beneficiaries
- Senate Republican blocked Wyden's bill for Treasury records
- DAG Blanche blocking DEA financial investigation

The $690M is the number reported by the two men who benefit from it being low. No independent audit has ever been conducted. That is not an accident. That is the cover-up.
