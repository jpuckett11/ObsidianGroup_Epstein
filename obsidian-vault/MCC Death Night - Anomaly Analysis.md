# MCC Death Night: Anomaly Analysis

## Official Finding: Suicide by hanging, August 10, 2019

## Evidence from our FBI logs cross-referenced with public record

---

## Timeline of Failures (every safety system disabled simultaneously)
...
| Jun 2024 | **FBI destroys master video copy** | Authorized evidence destruction |
| 2025 | Released video is **Adobe Premiere Pro reconstruction** | Not raw DVR footage |

---

## The Video Evidence Problem

From our FBI evidence log (EFTA02730741):

> "all video available for download for 8/10/2019, All relevant video from Special Housing Unit floor 9 and Attorney Visit area floor 3 from 7/23 to 8/10 2019"

> **"All video available to download for 8/9 (THIS DOWNLOAD FAILED)"**

> **"video downloaded by tech, (that is the wrong camera)"**

The FBI's own evidence log documents that:
1. The download of August 9 video **FAILED**
2. The tech downloaded the **WRONG CAMERA**
3. Despite having 16+ hard drives from the DVR systems

Then:
- FBI authorized destruction of master recording (June 2024)
- Released version was reconstructed using Adobe Premiere Pro
- 62-second gap at the critical midnight timeframe
- CBS forensics confirmed it's two separate videos spliced together

---

## The Medical Evidence

### Three neck fractures (unprecedented)

From autopsy (referenced in EFTA02730486):
- Left hyoid bone fracture
- Left thyroid cartilage fracture
- Right thyroid cartilage fracture

**Dr. Michael Baden** (former NYC Chief Medical Examiner, observed autopsy):
- "Never seen three fractures like this in a suicidal hanging"
- Based on "1,000+ jail hangings over 40-50 years"
- Three fractures are "much more consistent with homicidal strangulation"

**Official finding**: NYC Medical Examiner ruled suicide by hanging
...
## The Cellmate Question

**Sequence:**
1. Nick Tartaglione (former cop, charged with 4 murders) was Epstein's cellmate
2. July 23 "first attempt" happens while Tartaglione is cellmate
3. Tartaglione is moved out
4. Dr. Imeri emails that Epstein needs a cellmate
5. No cellmate assigned
6. Epstein found dead alone in cell
...
From deredacted evidence log:
> "Suspicious Activity Report Received from **JP Morgan Chase Regarding Tova Noel**"
...
This person has never been identified. The FBI could not determine who it was from the video. On a locked housing tier. In a maximum security federal facility. At 10:39 PM.

---

## Exfiltration Theory Assessment

### Evidence FOR exfiltration/murder:
1. Every safety system failed simultaneously (cameras, guards, cellmate, suicide watch)
2. Three neck fractures inconsistent with hanging (per Dr. Baden)
3. Unidentified "orange figure" accessed the tier 8 hours before death
4. Guard had suspicious banking (SAR from JPMorgan)
5. Guards got deferred prosecution (lenient treatment for cooperation?)
6. FBI destroyed master video evidence
7. Released video is reconstructed/edited
...
2. NYC Medical Examiner ruled suicide
3. Body was identified and autopsied
4. No physical evidence of a body switch
5. Multiple inmates and staff observed the aftermath
6. DOJ says "no credible evidence" of anything other than suicide

### What the documents uniquely show:
...
## Howard Lutnick Reference (NEW)

From FBI evidence log (EFTA02730741):
> "U NTOC2020 288hmb01 **Alleged Money Laundering by Howard Lutnick via BGC Financial and Cantor Fitzgerald**"

Howard Lutnick is the **current US Secretary of Commerce** (confirmed Jan 2025). An FBI tip alleging money laundering through his companies was logged as part of the Epstein investigation. The next entry references UK travel records (classified U//REL TO USA, GBR).

---

## Key Evidence Items in FBI Custody

| Item | Status |
|------|--------|
| 12+ DVR hard drives from MCC | In FBI custody |
| LTO-6 tape archives of video | In FBI custody |
| Master video recording | **DESTROYED** (June 2024) |
| Autopsy report + photos | In FBI/OCME custody |
| "Homemade Rope" from July 23 | In FBI custody |
| "One (1) torn sheet" | In FBI custody |
| Visitors Log | In FBI custody |
| SHU Inmate Log (Aug 9-10) | In FBI custody |
| TRU-SCOPE electronic logs | In FBI custody |
| Psychology reports (Jul 8, 9, 24) | In FBI custody |
| Dr. Imeri's cellmate email | In FBI custody |
| JPMorgan SAR on Tova Noel | In FBI custody |
| 30-minute round sheets | In FBI custody (show falsification) |
| Staff assignment logs | In FBI custody |

All of this evidence exists. Most of it has never been publicly released. The one piece that was released (the video) was first destroyed and then reconstructed using editing software.
...
> "**Watch calls will be made every 30 minutes from 6:00 PM to 6:00 AM**"
...
### Watch Call Timeline (what should have happened vs what did)

| Time | Required Action | What Actually Happened |
|------|----------------|----------------------|
| 10:30 PM | Watch call to Control Center | Last approach to Epstein's tier |
| 11:00 PM | Watch call | No call (guards falsifying) |
| 11:30 PM | Watch call | No call |
| 12:00 AM | Watch call + institutional count | Count slip falsified, no watch call |
| 12:30-6:00 AM | Watch call every 30 min (12 calls) | ZERO calls made |
| 6:30 AM | Breakfast delivery | Epstein found dead |

**12+ mandatory watch calls were missed. The Control Center received NONE of them. Nobody raised an alarm.**

---

## NEW: Camera System Deliberately Delayed? (pages 17364-17365)
...
## NEW: 12:00 AM Count Discrepancy (page 17350)

Thomas told the OIG:
> The midnight count slip listed **73 inmates** but the institutional count listed **72 inmates**

One inmate was unaccounted for between midnight and 3 AM. Thomas "did not know why the number was different." The 3 AM count listed 72. Where did inmate #73 go?

---

## COMPLETE MOVEMENT MAP: August 9-10, 2019
...
### Every Person Who Entered the SHU (per OIG findings)

| Time | Person | Purpose | How Confirmed |
|------|--------|---------|--------------|
| ~4:00 PM | Noel | Shift start | Schedule + video |
| ~4:00 PM | Officer-1 | Shift (2PM-10PM) | Schedule |
| ~4:00 PM | Officer-2 | Shift (4PM-12AM) | Schedule |
| ~7:49 PM | Evening Watch SHU OIC + Noel | Escorted Epstein to cell | Video |
| ~10:00 PM | Officer-1 departs | Shift end | Schedule |
| ~10:30 PM | Noel walks to tier door, walks back | Last approach | Video |
| ~12:00 AM | Thomas arrives, Officer-2 departs | Shift change | Video |
| **~4:00 AM** | **Overnight supervisor** | Brief visit, spoke with guards, LEFT | Video |
| **~5:30 AM** | **Another officer** | Walked through common area, NOT tiers | Video |
| ~6:00 AM+ | Breakfast cart delivery | Food service | Video |
| ~6:30 AM | Noel + Thomas enter L-Tier | Find Epstein | Video |
| ~6:33 AM | Supervisor-1 responds to alarm | Emergency | Video |

### The Gap: 10:30 PM to 4:00 AM (5.5 hours)
Per OIG: "the OIG did not observe on the available recorded video any correctional officers or other individuals approach the L Tier"
...
- Watch call phone records never released

**The OIG based its "no one entered" conclusion on video they admitted couldn't identify people or track their destinations, from a system where 10 of 11 cameras weren't working.**
...
## NEW: AG Barr Personally Watched the Tape (page 26283, 31253)

> "This is the tape that then Attorney General Barr publicly stated that he personally watched."

Barr saw the raw MCC surveillance footage BEFORE the FBI destroyed the original and released the Adobe Premiere Pro reconstruction. Whatever was on that tape, Barr called it suicide.

A federal judge later raised concerns sua sponte (unprompted) from the bench:
> "talking right now about how he thinks Barr hasn't done a satisfactory investigation about Epstein's death"

Senator Ben Sasse also wrote directly to Barr about the death ("sasse-letter-to-ag-barr-re-epstein-suicide.pdf").

## NEW: Polygraph of "BR" (page 27841)

> "Polygraph examination in March 2021 by Barry Colvert; BR was asked if ever had intimate physical contact with E[pstein]"

Someone with initials "BR" was polygraphed about physical contact with Epstein in March 2021. Identity unknown but initials preserved in the record.

---

## NEW: Transport Photo Forensic Inconsistencies
...
- Full autopsy photos (in FBI/OCME custody, not released)
- Transport documentation (paramedic notes, time stamps)
- Whether jaw was manually positioned or strapped
- Corneal examination notes from autopsy
- Exact time of transport (official record)

---

*Observation based on publicly available imagery. Forensic analysis principles applied. Not dispositive but inconsistent with official timeline.*
